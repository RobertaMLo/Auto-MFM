...
def diff2_fgrc_fgrc_goc(TF_goc, fm, fgrc, fgoc, w=0, df=1e-4):
    return (diff_fgrc_goc(TF_goc, fm, fgrc+df/2., fgoc)-diff_fgrc_goc(TF_goc,fm, fgrc-df/2., fgoc))/df
...
def diff2_fgrc_fm_goc(TF_goc, fm, fgrc, fgoc, w=0, df=1e-4):
   return (diff_fgrc_goc(TF_goc, fm+df/2., fgrc, fgoc)-diff_fgrc_goc(TF_goc, fm-df/2., fgrc, fgoc))/df
...
def diff2_fgrc_fgoc_goc(TF_goc, fm, fgrc, fgoc, w=0, df=1e-4):
    return (diff_fgrc_goc(TF_goc, fm, fgrc, fgoc+df/2.-diff_fgrc_goc(TF_goc, fm, fgrc, fgoc-df/2.))/df)
