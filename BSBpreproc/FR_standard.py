...
def main():
    ...
    parser.add_argument("sim_nio_name", help="FULL path of the nio_files created during simulation")
    parser.add_argument("--sim_type", help="bame of the simulation in the hdf5 file", default='basal_activity')
    ...
    csv_name_suffix = '_fr_for_TF_plus' #without the extension - working frequency for numTF saved in these csv stored in the WORKIN DIRECTORY (4 csv file)
