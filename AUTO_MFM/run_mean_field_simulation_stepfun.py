...
if __name__ == '__main__':
    ...
    parser.add_argument('-alfa', default=[1.8, 2.9, 1.9, 2.7], #fist trial [2., 1.7, 3., 10.]
    ...
    parser.add_argument('-t_start', type=int, default=1250,
                        help ="start of the stimulus")

    parser.add_argument('-t_end', type=int, default=3750,
                        help ="end of the stimulus")

    parser.add_argument('-freq_s', type=int, default=100,
                        help ="freqof the stimulus")
    ...
    outdir_name= str(args.freq_s)+'_'+NTWK
    ...
    # Loading the Transfer Functions
    # TO BE UPDATE: during fitting, create a folder for each p-optimization
    #FILE_GrC = root_path  + '20250605_185329_GrC_CRBL_CONFIG_PLV_KandQ_tsim5_alpha1.8_fit.npy'
    #FILE_GoC = root_path + '20250605_201432_GoC_CRBL_CONFIG_PLV_KandQ_tsim5_alpha1.4_fit.npy'
    #FILE_MLI = root_path + '20250616_120320_MLI_CRBL_CONFIG_PLV_KandQ_v3_tsim5_alpha1.5_fit.npy'
    #FILE_PC = root_path + '20250605_185424_PC_CRBL_CONFIG_PLV_KandQ_tsim5_alpha2.7_fit.npy'

    #FILE_GrC = root_path + '20250605_185329_GrC_CRBL_CONFIG_PLV_KandQ_tsim5_alpha1.8_fit.npy'
    #FILE_GoC = root_path + '20250605_201432_GoC_CRBL_CONFIG_PLV_KandQ_tsim5_alpha1.4_fit.npy'
    #FILE_MLI = root_path + '20250616_120320_MLI_CRBL_CONFIG_PLV_KandQ_v3_tsim5_alpha1.5_fit.npy'
    #FILE_PC = root_path + '20250616_114305_PC_CRBL_CONFIG_PLV_KandQ_v2_tsim5_alpha2.8_fit.npy'

    ## CLEANEST ##
    FILE_GrC = root_path + '20250605_185329_GrC_CRBL_CONFIG_PLV_KandQ_tsim5_alpha1.8_fit.npy'
    FILE_GoC = root_path + '20250617_211539_GoC_CRBL_CONFIG_PLV_KandQ_GoCasothers_tsim5_alpha2.9_fit.npy'
    FILE_MLI = root_path + '20250605_185426_MLI_CRBL_CONFIG_PLV_KandQ_tsim5_alpha1.9_fit.npy'
    FILE_PC = root_path + '20250605_185424_PC_CRBL_CONFIG_PLV_KandQ_tsim5_alpha2.7_fit.npy'
    ...
    f_mossy = np.random.rand(len(t))*f_backnoise #background noise set around 4 Hz

    f_tone = rect_input(time=t, t_start=args.t_start, t_end=args.t_end, minval=0, freq=args.freq_s, noise_freq=0)
    #fmossy_sens = fmossy_cort + f_tone
    fmossy_sens = f_mossy+ f_tone
    print(np.max(fmossy_sens))

    CI_vec = [0.5, 5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, fmossy_sens[0], 15, 38, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]

    X_sim = find_fixed_point_mossy(TFgrc, TFgoc, TFmli, TFpc, CI_vec, t, w, fmossy_sens,
    ...
    plot_MF_activity_withSD(t[t_trans:], X_sim[t_trans:], fmossy_sens[t_trans:],
