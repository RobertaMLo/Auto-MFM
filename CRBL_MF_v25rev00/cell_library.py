...
def get_neuron_params(NAME,  SI_units=True, name='', number=1):
    if NAME == 'GrC':
        ...
        params = {'name': name, 'N': number,
                  ...
                  'kadap': 2.025, 'k2': 1.096, 'k1': 1.887, 'A2': 5.863, 'A1': 5.953, 'Ie': 3.711*1.2} #mf PLOS version:3.711*1.2

    elif NAME == 'PC':
        params = {'name': name, 'N': number,
                  'Gl': 7.1064, 'Cm': 334., 'Trefrac': 0.5, 'tm': 47.,
                  'El': -59., 'Vthre': -43., 'Vreset': -69., 'delta_v': 3.5,
                  'kadap': 1.491, 'k2': 0.041, 'k1': 0.195, 'A2': 172.622, 'A1': 157.622, 'Ie': 700.*1.2} #mf PLOS version:742.54*1.2
